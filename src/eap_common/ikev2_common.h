...
enum {
	...
	IKEV2_PAYLOAD_CONFIGURATION = 47,
...
/* IKEv2 Proposal - SPI Size */
enum {
	IKEV2_SPI_SIZE_INITIAL = 0,
	IKEV2_SPI_SIZE_AH_ESP = 4,
	IKEV2_SPI_SIZE_IKE = 8 /* IKE is the only one allowed for EAP-IKEv2 */
};
...
/* Traffic Selector Type (RFC 4306, Sect. 3.13)*/
enum {
	TS_IPV4_ADDR_RANGE = 7,
	TS_IPV6_ADDR_RANGE = 8
};

/* Traffic Selector IP Protocol */
enum {
	IP_PROTO_ANY = 0,
	IP_PROTO_IPV4 = 4,
	IP_PROTO_TCP = 6,
...
enum {
	ATTRIBUTE_TYPE_RESERVED = 0,
	ATTRIBUTE_TYPE_INTERNAL_IP4_ADDRESS = 1,
	ATTRIBUTE_TYPE_INTERNAL_IP4_NETMASK = 2,
	ATTRIBUTE_TYPE_INTERNAL_IP4_DNS = 3,
	ATTRIBUTE_TYPE_INTERNAL_IP4_NBNS = 4,
	ATTRIBUTE_TYPE_INTERNAL_ADDRESS_EXPIRY = 5,
	ATTRIBUTE_TYPE_INTERNAL_IP4_DHCP = 6,
	ATTRIBUTE_TYPE_APPLICATION_VERSION = 7,
	ATTRIBUTE_TYPE_INTERNAL_IP6_ADDRESS = 8,
	ATTRIBUTE_TYPE_INTERNAL_IP6_DNS = 10,
	ATTRIBUTE_TYPE_INTERNAL_IP6_NBNS = 11,
	ATTRIBUTE_TYPE_INTERNAL_IP6_DHCP = 12,
	ATTRIBUTE_TYPE_INTERNAL_IP4_SUBNET = 13,
	ATTRIBUTE_TYPE_SUPPORTED_ATTRIBUTES = 14,
	ATTRIBUTE_TYPE_INTERNAL_IP6_SUBNET = 15
};

/* Notify Private Status Type TS24.502 Clause 9.2.4.3 */
enum {
	NOTIFY_5G_QOS_INFO = 55501,
	NOTIFY_NAS_IP4_ADDRESS = 55502,
	NOTIFY_NAS_IP6_ADDRESS = 55503,
	NOTIFY_UP_IP4_ADDRESS = 55504,
	NOTIFY_UP_IP6_ADDRESS = 55505,
	NOTIFY_NAS_TCP_PORT = 55506,
	NOTIFY_N3GPP_BACKOFF_TIMER = 55507
};
