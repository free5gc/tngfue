...
static void eapol_sm_txSuppRsp_ext(void *ctx)
{
	...
	sm->dot1xSuppEapolRespFramesTx++;
	sm->dot1xSuppEapolFramesTx++;
	wpa_printf(MSG_DEBUG, "finally back");
}
...
/**
* eapol_ikev2_conn: vendor test ikev2 connection setup 
*/
#ifdef EAP_VENDOR_TEST
void eapol_ikev2_conn(struct eapol_sm *sm)
{
